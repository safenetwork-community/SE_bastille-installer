...
pub const ARG_DELETE: &str = "-delete";
pub const ARG_DN: &str = "-dn";
pub const ARG_EMPTY: &str = "-empty";
...
pub const ARL_RSF: &str = "--remove-source-files";
pub const ARL_CHOWN_ROOT: &str = "--chown=root:root";

// command specific arguments
pub const ACS_BS_1M: &str = "bs=1M";
pub const ACS_C_PERCENT: &str = "100%";
pub const ACS_CR: &str = "cr";
pub const ACS_D: &str = "d";
